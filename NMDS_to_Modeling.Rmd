...
b10 <- makeblastdb(file = "~/1. PhD_Main/GitHub_link/Nittedal/Diet_Myotis_brandts_mystacinus/TryThis.fasta", dbtype = "nucl", args = "")
BL <- blast(db = "~/1. PhD_Main/GitHub_link/Nittedal/Diet_Myotis_brandts_mystacinus/TryThis.fasta", type = "blastn")
# Example data 
