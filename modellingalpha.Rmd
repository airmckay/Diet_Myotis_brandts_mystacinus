...
# The null hypothesis has a significant p value so there is strong evidence that the two models are very different... 
...
#summary(pframe1)
pframe1$pred.alpha1 <- get_predicted(m2, newdata = pframe1)
